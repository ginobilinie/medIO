...
'''
def extractPatches4OneSubject(matFA,matSeg,fileID,d,step,rate):
    ...
    with open('./trainPelvic3x168x112_all29_list.txt','a') as f:
        f.write('/raid/dongnie/train3x168x112_%s.h5\n'%fileID)
    return cubicCnt
...
def main():
    ...
    for ind in ids:
        ...
        fileID='%d'%ind
        cubicCnt=extractPatches4OneSubject(mrimg,labelimg,fileID,dFA,step,rate)
