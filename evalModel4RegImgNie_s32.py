...
mynet = caffe.Net(protopath+'prostate_deploy_v5_3.prototxt',protopath+'pro_fcn_v5_3_iter_82000.caffemodel',caffe.TEST)
        ...
        for j in range(0,col-d[1],step[1]):
            for k in range(0,leng-d[2],step[2]):
                ...
                if rate!=1 and i%resizeRate==0 and j%resizeRate==0 and k%resizeRate==0:
                    ...
                    temppremat = mynet.blobs['conv3e_bn'].data[0] #Note you have add softmax layer in deploy prototxt
